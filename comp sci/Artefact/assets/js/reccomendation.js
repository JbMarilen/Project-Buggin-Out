document.getElementById('compareButton').addEventListener('click', function() {
    ...
    const yeas = [2015, 2016, 2017, 2018, 2019];
    const files = {
        ...
        fetch(files[year])
            ...
            .then(csvText => {
                ...
                if (countryData) {
                    ...
                    totalHappinessRank += happinessRank; // Add this line to accumulate the ranks
                    count++;
            ...
            .then(() => {
                ...
                if (count === years.length) {
                    ...
                    let happinessCategory, economyCategory, healthCategory;
